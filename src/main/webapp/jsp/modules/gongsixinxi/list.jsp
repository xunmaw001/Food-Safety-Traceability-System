...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">公司信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>公司信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">公司信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="gongsidizhiSearch" class="form-control form-control-sm" placeholder="请输入公司地址" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>经营范围</th>
											<th onclick="sort('chuangliriqi')">创立日期<i id="chuangliriqiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#gongsidizhiSearch').val() != null && $('#gongsidizhiSearch').val() != ''){
				searchForm.gongsidizhi ="%" +  $('#gongsidizhiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("gongsixinxi/page","GET",{
				...
				gongsidizhi : searchForm.gongsidizhi,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var jingyingfanweiCell  = document.createElement('td');
						  ...
						  if(item.jingyingfanwei != null && item.jingyingfanwei != "" && item.jingyingfanwei.length >= 11){
			  	jingyingfanweiCell.innerHTML = item.jingyingfanwei.substring(0, 10) + "..."; 
			  }else{
			...
			var chuangliriqiCell  = document.createElement('td');

						  chuangliriqiCell.innerHTML = item.chuangliriqi;


			row.appendChild(chuangliriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("gongsixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discussgongsixinxi/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"gongsixinxi");
