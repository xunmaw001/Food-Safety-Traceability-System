					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>材料类型管理</span></li>
								<li class="breadcrumb-item active"><span>编辑材料类型</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "cailiaoleixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("cailiaoleixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("cailiaoleixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("cailiaoleixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("cailiaoleixing"+colName,"GET",{
