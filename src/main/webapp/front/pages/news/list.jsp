...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" :style='{"padding":"10px 0 10px 0","boxShadow":"1px -10px 0px 0px #337e6a","margin":"20px auto 10px ","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"rgba(241, 241, 241, 1)","color":"rgba(51, 126, 106, 1)","borderRadius":"32px","alignItems":"center","borderWidth":"1px","fontSize":"20px","borderStyle":"solid"}'>
			  <span>NEWS / INFORMATION</span><span>新闻信息</span>
			</div>
			<!-- 标题 -->
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"rgba(110,22,64,0)","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px #da9939","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(241, 241, 241, 1)","borderRadius":"4px","alignItems":"center","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						...
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"0","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="title" id="title" placeholder="标题" autocomplete="off" class="layui-input">
					</div>
					...
					<div class="list news list3">
												<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" :style='{"padding":"12px 50px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"20px 0","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"#fff","borderRadius":"100px 0 100px 0","borderWidth":"20px 0 0 0","width":"100%","borderStyle":"solid","height":"auto"}' class="list-item-body animation-box">
							<div class="h">
								<div class="title" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"18px","borderStyle":"solid"}'>{{item.title}}</div>
								<div class="time" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.addtime}}</div>
							</div>
							...
							<div class="tag" :style='{"padding":"0 12px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(51, 126, 106, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"72px","lineHeight":"24px","fontSize":"12px","borderStyle":"solid"}'>新闻动态</div>
						</div>
					</div>
