		...
		<div id="app">
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"rgba(110,22,64,0)","borderStyle":"solid"}'>
				<div class="box" style='width:1100px'>
					  ...
					  <span>DATA SHOW</span><span>公司信息展示</span>
					</div>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px #da9939","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(241, 241, 241, 1)","borderRadius":"4px","alignItems":"center","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							...
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"0","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="gongsimingcheng" id="gongsimingcheng" placeholder="公司名称" autocomplete="off" class="layui-input">
						</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(58, 58, 58, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>公司地址</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"0","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="gongsidizhi" id="gongsidizhi" placeholder="公司地址" autocomplete="off" class="layui-input">
						</div>
						...
						<div class="list" style="position: relative;">
							<div @click="jump('../gongsixinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"20px","boxShadow":"11px -11px 0px 0px #337e6a","margin":"20px 20px 10px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"0 40px 0 40px","borderWidth":"1px","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(51, 126, 106, 1)","borderRadius":"0","borderWidth":"5px","width":"160px","borderStyle":"solid","height":"200px"}' :src="item.fengmian?baseurl+item.fengmian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"#666","borderRadius":"0","textAlign":"right","width":"100%","fontSize":"14px"}' class="name">{{item.gongsimingcheng}}</div>
									</div>
								</div>
							</div>
						</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				function pageList() {
			        ...
			        if (jquery('#gongsidizhi').val()) {
			          param['gongsidizhi'] = jquery('#gongsidizhi').val() ? '%' + jquery('#gongsidizhi').val() + '%' : '';
			        }
				...
				if (jquery('#gongsidizhi').val()) {
					...
					// 获取列表数据
					http.request('gongsixinxi/list', 'get', param, function(res) {
