				...
				<div class="box" style='width:1100px'>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px #da9939","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(241, 241, 241, 1)","borderRadius":"4px","alignItems":"center","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							...
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"0","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="zhanghao" id="zhanghao" placeholder="账号" autocomplete="off" class="layui-input">
						</div>
						<div class="item-list">
							...
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(51, 126, 106, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"0","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="xingming" id="xingming" placeholder="姓名" autocomplete="off" class="layui-input">
						</div>
						...
						<div class="list" style="position: relative;">
							<div @click="jump('../yonghu/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"20px","boxShadow":"11px -11px 0px 0px #337e6a","margin":"20px 20px 10px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"0 40px 0 40px","borderWidth":"1px","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(51, 126, 106, 1)","borderRadius":"0","borderWidth":"5px","width":"160px","borderStyle":"solid","height":"200px"}' :src="item.zhaopian?baseurl+item.zhaopian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"#666","borderRadius":"0","textAlign":"right","width":"100%","fontSize":"14px"}' class="name">{{item.xingming}}</div>
									</div>
								</div>
							</div>
						</div>
