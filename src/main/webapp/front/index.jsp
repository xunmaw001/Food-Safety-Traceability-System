...
<html>
	...
	<style type="text/css">
		...
		#header .navs li {
			...
			box-shadow: 0px -20px 0px 0px #797979;
			text-align: center;
			box-sizing: border-box;
			cursor: pointer;
		}
		...
		#header .navs li.current {
			...
			border-color: rgba(0,0,0,.3);
			background-color: #f7f7f7;
			box-shadow: 0px -20px 0px 0px #337E6A;
		}
	...
	<body>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(51, 126, 106, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;">
